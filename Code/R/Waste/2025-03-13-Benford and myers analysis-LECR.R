...
# The primary goal of this script is to analyze wage data to detect potential 
# data quality issues or manipulations by comparing the distribution of first 
# digits of wage values to what's expected under Benford's Law. Additionally, 
# it calculates the Myers Index, which typically measures digit preference in age data.
...
# Output paths
output_path_excel_modified <- "C:/Users/User/OneDrive/OneDrive - Universidad de los andes/Felipe Balcazar/Project on State capacity/Data/GLD"
output_path_PNG_modified   <- "C:/Users/User/OneDrive/OneDrive - Universidad de los andes/Felipe Balcazar/Project on State capacity/Data/GLD/Output"
